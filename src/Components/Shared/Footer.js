...
const Footer = () => {
    return (
        <footer style={{backgroundColor: "rgba(0, 0, 0, 0.5);"}} class=" mt-14 footer footer-center bg-black p-10 ">
  <div className='text-white'>
    ...
    <p class="font-bold">
      Tools Mart Industries Ltd. <br/>Providing mordern tools since 1992
    </p> 
  ...
  <div>
    <div>
     <ul className='flex'>
     <li><a className='text-white ml-2 text-2xl hover:text-sky-400 p-2 rounded-md' href='#'><FontAwesomeIcon icon={faFacebook}></FontAwesomeIcon></a></li>
     <li><a className='text-white ml-4 text-2xl hover:text-red-400 p-2 rounded-md' href='#'><FontAwesomeIcon icon={faYoutube}></FontAwesomeIcon></a></li>
     <li><a className='text-white ml-4 text-2xl hover:text-sky-400 p-2 rounded-md' href='#'><FontAwesomeIcon icon={faTwitter}></FontAwesomeIcon></a></li>
     <li><a className='text-white ml-4 text-2xl hover:text-sky-400 p-2 rounded-md' href='#'><FontAwesomeIcon icon={faLinkedin}></FontAwesomeIcon></a></li>
     </ul>
    </div>
  </div>
</footer>
